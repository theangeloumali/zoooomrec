...
5. Approve **Phase 0 macOS spike** as immediate next step (~24h): ScreenCaptureKit capture + CGEventTap click stream + one auto-zoom rendered with spring easing, compared side-by-side against a Screen Studio export.
