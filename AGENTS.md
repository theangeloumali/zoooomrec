# zoooomrec — instructions for contributors and AI agents

This file is the canonical brief for anyone working on this repository — human or AI, any model. (`CLAUDE.md` is only a pointer to this file.)
